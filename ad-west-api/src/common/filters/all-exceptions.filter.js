...
var AllExceptionsFilter = function () {
    ...
    var AllExceptionsFilter = _classThis = /** @class */ (function () {
        ...
        AllExceptionsFilter_1.prototype.catch = function (exception, host) {
            ...
            response.status(status).json(__assign({ success: false, statusCode: status, timestamp: new Date().toISOString(), path: request.url, error: message }, (process.env.NODE_ENV === 'development' && {
                details: error,
            })));
        };
