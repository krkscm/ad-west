...
export const PLATFORM_ENUM_SEEDS: EnumSeedRow[] = [
  ...
  // Household
  { enumType: ENUM_TYPES.PRIMARY_CONTACT_STRATEGY, value: 'HOUSEHOLD_HEAD', label: 'Household head (one contact per row)', sortOrder: 10, active: true, parentValue: 'household_head' },
  { enumType: ENUM_TYPES.PRIMARY_CONTACT_STRATEGY, value: 'FEMALE_PARTICIPANTS', label: 'Female participants (ladies Srenis)', sortOrder: 20, active: true, parentValue: 'female_participants' },
  ...
  { enumType: ENUM_TYPES.ENROLLMENT_SCOPE, value: 'HOUSEHOLD', label: 'Household-level division', sortOrder: 10, active: true, parentValue: null },
  { enumType: ENUM_TYPES.ENROLLMENT_SCOPE, value: 'MEMBER', label: 'Per-member enrollment', sortOrder: 20, active: true, parentValue: null },
  { enumType: ENUM_TYPES.HOUSEHOLD_MEMBER_ROLE, value: 'head', label: 'Head of household', sortOrder: 10, active: true, parentValue: null },
