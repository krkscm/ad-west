...
const STATIC_PATH_TO_TAB: Record<string, string> = {
  ...
  '/admin/general-services/join-us-review': 'governance-join-us-review',
  ...
  '/admin/settings/locations/new': 'settings-location-definition-form',
  '/admin/settings/sreni': 'settings-sreni-definition',
  '/admin/settings/sreni/new': 'settings-sreni-definition-form',
  '/admin/settings/permissions': 'settings-permissions',
  '/admin/settings/permissions/new': 'settings-permissions-form',
  '/admin/settings/permission-sets': 'settings-permission-sets',
  '/admin/settings/permission-sets/new': 'settings-permission-sets-form',
...
export const ADMIN_PAGE_TITLES: Record<string, string> = {
  ...
  'governance-join-us-review': 'Join Us Review',
  ...
  'settings-location-definition-form': 'Location Form',
  'settings-sreni-definition': 'Sreni Definition',
  'settings-sreni-definition-form': 'Sreni Form',
  'settings-permissions': 'Permissions',
  'settings-permissions-form': 'Permission Form',
  'settings-permission-sets': 'Permission Sets',
  'settings-permission-sets-form': 'Permission Set Form',
